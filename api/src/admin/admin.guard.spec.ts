...
describe('AdminGuard', () => {
  ...
  it('should throw ForbiddenException when JWT publicKey does not match on-chain admin', async () => {
    // Use a different valid Stellar account (not ADMIN) — generated by Keypair.random()
    const otherAdmin = 'GBWV4GYSBBZ73RZVLKQ6LX67DY44PTJMQ27RC3BUDFY32LURUMGIECG7';
    mockStellar.readContract.mockResolvedValue(
      nativeToScVal(otherAdmin, {
        type: 'address',
      }),
    );
    await expect(
